		    	...
		    	<div class="container cont-main">
					<div class="code-sample">
						<div class="tab-output row">
							<h3><g:message code="apply.title.label"/></h3>
							<g:if test="${listQuiz}">
										...
										<tr>
											...
											<td style="text-align: center;">
												<g:link action="allocateQuestions" params="[id:quiz?.id]">
													<button class="btn btn-primary pull-right" type="submit"><i class="fa fa-cog"></i>&nbsp;<g:message code="default.button.applyQuiz.label"/></button>
												</g:link>
											</td>
										</tr>
									</g:each>
