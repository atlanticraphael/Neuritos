...
function doLMSInitialize()
{
   ...
   if (api == null)
   {
      console.info("Unable to locate the LMS's API Implementation.\nLMSInitialize was not successful.");
      return "false";
   }
...
// {
//    // debugger;
//    return "6$1;1110000000000000000000000000000";
// }
...
function getAPI()
{
   ...
   if (theAPI == null)
   {
      console.info("Unable to find an API adapter");
   }
   return theAPI
}
