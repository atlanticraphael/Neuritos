...
// Identifica qual é o ID do tópico para ser utilizado durante as funções de setagem de variáveis.
var idFlash = "topico";

// Armazena a página que o usuário parou
var pagina = 0;
...
/**
 * Carrega o SWF levando as informações passadas no HTML
 * @param largura - Valor numérico para a largura do SWF ou string 100% para ser redimensionável
 * @param altura - Valor numérico para a altura do SWF ou string 100% para ser redimensionável
...
/**
 * Atribui valor true a variável do objeto tópico da janela pai
 */
