...
/**
 * http://stackoverflow.com/questions/8333998/grails-sequence-generation-for-oracle-11g
 * 
 * @author Aluno005
 *
 */
public class SequencePerTableOracleDialect extends Oracle10gDialect {
    ...
    public static class TableNameSequenceGenerator extends SequenceGenerator {
        ...
        String createSequenceName(final String tableName) {
        	String nameSequence = "seq_" + tableName.substring(4);
            return nameSequence.length() > 30 ? nameSequence.substring(0, 30) : nameSequence;
        }
    }
}